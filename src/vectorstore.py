...
class FaissVectorStore:
    ...
    def build_from_documents(
        ...
        print(
            f"[INFO] Vector store built and saved to {self.persist_dir}"
        )
    ...
    def add_embeddings(
        ...
        print(
            f"[INFO] Added {embeddings.shape[0]} vectors to Faiss index."
        )
    ...
    def save(self):
        ...
        print(
            f"[INFO] Saved Faiss index and metadata to {self.persist_dir}"
        )
